...
void help( void ) 
{
    printf("usage: slda [est] [data] [answers] [settings] [alpha] [tau] [k] [random/seeded/model_path] [seed] [directory]\n");
    printf("       slda [estinf] [data] [answers] [settings] [alpha] [tau] [k] [random/seeded/model_path] [seed] [directory]\n");
